...
def main(dropout):
    ...
    indices, entropy, fcn_model = consensus_entropy_dropout(fcn_model, train_dataset_idx, train_index, idx_ratio,
...
if __name__ == '__main__':
    main(dropout=0.9)  # qbc_semseg(n_model, n_train, batch_size)
