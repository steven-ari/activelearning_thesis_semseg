...
def main():
    ...
    output_path = os.path.join(dr(dr(dr(dr(abspath(__file__))))), 'results', 'f_mnist', 'AE_output_f_mnist.pt')
    input_path = os.path.join(dr(dr(dr(dr(abspath(__file__))))), 'results', 'f_mnist', 'AE_input_f_mnist.pt')
