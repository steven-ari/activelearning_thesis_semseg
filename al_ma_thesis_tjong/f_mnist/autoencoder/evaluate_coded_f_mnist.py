...
from al_ma_thesis_tjong.presets.dataset_preset import Reduced_F_MNIST
...
def main():
    ...
    # dataset
    train_dataset = Reduced_F_MNIST(root=mnist_root, train=True)
    test_dataset = Reduced_F_MNIST(root=mnist_root, train=False)
