...
def qbc(n_model, n_train, qbc_batch_size, batch_size, idx_ratio, dataset):
    ...
    text = (('CE_batchless: n_model: ' + str(n_model)) + (', n_train: ' + str(n_train)) + (', batch_size: ' + str(batch_size))
    ...
    title = ["CE_batchless: Training progress for n_model = " + str(n_model) + ", idx_ratio:  " + str(idx_ratio) + ', for multiple epoch']
