    ...
    if idx_ratio[1] < 1.0:
        ...
        with torch.no_grad():
            for i_batch, (data, target, index, _) in enumerate(train_dataloader):
                ...
                del data, target
                ve_batch = vote_entropy_semseg_old(output_list_train, segmen_preset.labels_valid)
...
def main():
    ...
    for i_epoch in range(n_epoch):
        ...
        # append with vote entropy
            ...
            indices, fcn_model = vote_entropy_dropout(fcn_model, train_dataset_idx, train_index, idx_ratio,
