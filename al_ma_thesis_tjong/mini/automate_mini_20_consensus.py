...
from al_ma_thesis_tjong.mini import bulk_20_mini_getter as getter_mini


if __name__ == '__main__':

    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_20_mini_getter_from_consensus_90_001_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_20_mini_getter_from_consensus_90_002_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_20_mini_getter_from_consensus_90_003_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_20_mini_getter_from_consensus_90_004_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_20_mini_getter_from_consensus_90_005_'
