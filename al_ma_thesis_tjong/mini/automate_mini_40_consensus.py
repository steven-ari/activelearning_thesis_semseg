...
if __name__ == '__main__':
    ...
    dir_name_input = 'bulk_40_mini_getter_from_consensus_90_001_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_40_mini_getter_from_consensus_90_002_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_40_mini_getter_from_consensus_90_003_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_40_mini_getter_from_consensus_90_004_'
    ...
    source_path_input = os.path.join(dr(dr(dr(abspath(__file__)))), 'results', 'consensus_test')
    dir_name_input = 'bulk_40_mini_getter_from_consensus_90_005_'
